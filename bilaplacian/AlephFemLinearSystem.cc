...
//        Real v4  = K_e(2*n1_index+1,   2*n2_index+1 );  
    ...
    m_aleph_matrix->addValue(m_node_variable, item_list_view[row*2], m_node_variable, item_list_view[column*2], value1);
    m_aleph_matrix->addValue(m_node_variable, item_list_view[row*2], m_node_variable, item_list_view[column*2+1], value2);
    m_aleph_matrix->addValue(m_node_variable, item_list_view[row*2+1], m_node_variable, item_list_view[column*2], value3);
    m_aleph_matrix->addValue(m_node_variable, item_list_view[row*2+1], m_node_variable, item_list_view[column*2+1], value4);
  }
