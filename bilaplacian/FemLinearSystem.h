...
class FemLinearSystemImpl
{
 ...
 public:
  ...
  virtual void matrixAddValue(Arcane::NodeLocalId row, Arcane::NodeLocalId column, Arcane::Real value1, Arcane::Real value2, Arcane::Real value3, Arcane::Real value4) = 0;
...
class FemLinearSystem
{
 ...
 public:
  ...
  void matrixAddValue(Arcane::NodeLocalId row, Arcane::NodeLocalId column, Arcane::Real value1,  Arcane::Real value2, Arcane::Real value3,  Arcane::Real value4);
