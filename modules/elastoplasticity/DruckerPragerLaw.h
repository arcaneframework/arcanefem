...
ARCCORE_HOST_DEVICE void computeMaterialTensorDruckerPragerTria3Base(RealMatrix<3, 3>& C_tang_gp,
                                                                    ...
                                                                    const Real& in_mu)
{
  ...
  Real sigma_xx = (1. - apex_switch) * sigma_trial_xx - lambda_smooth * correction_xx + apex_switch * in_dpC / in_dpEta;
  Real sigma_yy = (1. - apex_switch) * sigma_trial_yy - lambda_smooth * correction_yy + apex_switch * in_dpC / in_dpEta;
  Real sigma_xy = (1. - apex_switch) * sigma_trial_xy - lambda_smooth * correction_xy;
  Real sigma_zz = (1. - apex_switch) * sigma_trial_zz - lambda_smooth * correction_zz + apex_switch * in_dpC / in_dpEta;
...
inline void FemModuleElastoplasticity::_updateGlobalTangentMaterialTensorDruckerPragerTria3Cpu()
{
  ENUMERATE_ (Cell, icell, allCells())
  {
    ...
    for (Int8 iGP = 0; iGP < m_nGP; ++iGP ) {
      ...
      computeMaterialTensorDruckerPragerTria3Base(C_tang_gp,
