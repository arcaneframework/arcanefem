...
/*---------------------------------------------------------------------------*/
#ifndef ARCANFEM_ELASTOPLATICITY2_ELEMENTMATRIX_H
#define ARCANFEM_ELASTOPLATICITY2_ELEMENTMATRIX_H
/*---------------------------------------------------------------------------*/
/*---------------------------------------------------------------------------*/
...
/*---------------------------------------------------------------------------*/
/**
 * @brief Computes the element matrix for a triangular element (ℙ1
 * FE).
 *
 * Theory:
 *
 ...
 */
inline ARCCORE_HOST_DEVICE RealMatrix<6, 6>
computeElementMatrixTria3Base(Real3 dxu, Real3 dyu, Real area, RealMatrix<3, 3> C_tang)
{
...
/*---------------------------------------------------------------------------*/
inline ARCCORE_HOST_DEVICE RealMatrix<6, 6>
computeElementMatrixTria3Gpu(CellLocalId cell_lid, const IndexedCellNodeConnectivityView& cn_cv,
                             const Accelerator::VariableNodeReal3InView& in_node_coord,
                             const Accelerator::MeshMDVariableInView<Cell, double, ExtentsV<int, -1, -1, -1>>& in_C_tang)
{
...
inline RealMatrix<6, 6> Elastoplasticity2Module::
...
inline ARCCORE_HOST_DEVICE RealMatrix<2, 6>
computeElementVectorTria3GpuBase(Real3 dxu, Real3 dyu, Real area, RealMatrix<3, 3> C_tang, Int32 node_lid)
{
...
inline ARCCORE_HOST_DEVICE RealMatrix<2, 6>
computeElementVectorTria3Gpu(CellLocalId cell_lid, const IndexedCellNodeConnectivityView& cn_cv,
                             const Accelerator::VariableNodeReal3InView& in_node_coord,
                             const Accelerator::MeshMDVariableInView<Cell, double, ExtentsV<int, -1, -1, -1>>& in_C_tang,
                             Int32 node_lid)
{
...
inline RealMatrix<12, 12> Elastoplasticity2Module::
...
inline ARCCORE_HOST_DEVICE RealMatrix<3, 12>
