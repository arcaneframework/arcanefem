...
//-----------------------------------------------------------------------------
/*---------------------------------------------------------------------------*/
/* ExternalBodyForce.cc                                        (C) 2000-2026 */
/*                                                                           */
...
_applyExternalBodyForce(VariableDoFReal& rhs_values,
...
_applyExternalBodyForceQuad4Cpu(VariableDoFReal& rhs_values,
                                const IndexedNodeDoFConnectivityView& node_dof)
{
...
inline void Elastoplasticity2Module::
_applyExternalBodyForceQuad8Cpu(VariableDoFReal& rhs_values,
                                const IndexedNodeDoFConnectivityView& node_dof)
{
...
inline void Elastoplasticity2Module::
_applyExternalBodyForceQuad9Cpu(VariableDoFReal& rhs_values,
                                const IndexedNodeDoFConnectivityView& node_dof)
{
  constexpr Real gp[3] = { -0.77459666924148337704, 0.0, 0.77459666924148337704 };
  constexpr Real weights[3] = { 5.0 / 9.0, 8.0 / 9.0, 5.0 / 9.0 };
