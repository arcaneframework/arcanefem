...
//-----------------------------------------------------------------------------
/*---------------------------------------------------------------------------*/
/* InternalBodyForce.cc                                        (C) 2000-2026 */
/*                                                                           */
...
_applyInternalBodyForce(VariableDoFReal& rhs_values,
...
void Elastoplasticity2Module::
_applyInternalBodyForceQuad4Cpu(VariableDoFReal& rhs_values,
                                const IndexedNodeDoFConnectivityView& node_dof)
{
 ...
 */
void Elastoplasticity2Module::
_applyInternalBodyForceQuad8Cpu(VariableDoFReal& rhs_values,
                                const IndexedNodeDoFConnectivityView& node_dof)
{
...
void Elastoplasticity2Module::
_applyInternalBodyForceQuad9Cpu(VariableDoFReal& rhs_values,
                                const IndexedNodeDoFConnectivityView& node_dof)
{
  constexpr Real gp[3] = { -0.77459666924148337704, 0.0, 0.77459666924148337704 };
  constexpr Real weights[3] = { 5.0 / 9.0, 8.0 / 9.0, 5.0 / 9.0 };
...
*        using CPUs.
*/
ARCCORE_HOST_DEVICE RealVector<6>
...
void Elastoplasticity2Module::
_applyInternalBodyForceTria3Cpu(VariableDoFReal& rhs_values,
                                const IndexedNodeDoFConnectivityView& node_dof)
{
