...
RealMatrix<4, 4> FemModuleElectrostatics::_computeElementMatrixQuad4(Cell cell)
{
...
RealMatrix<8, 8> FemModuleElectrostatics::_computeElementMatrixHexa8(Cell cell)
{
