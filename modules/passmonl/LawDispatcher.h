...
public:
    ...
    bool computeStress(bool init, bool isRef, const int& dim);
...
private:
    std::function<bool(RealUniqueArray* law_params, RealUniqueArray* history_vars, Tensor2& sig, Tensor2& eps, Tensor2& epsp, Tensor2& dsig,
                       const Tensor2& deps, Tensor4& tangent_tensor, const int& dim, bool isRef)> m_compute_stress[NB_LAW_TYPE];
