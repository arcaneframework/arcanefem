...
//-----------------------------------------------------------------------------
/*---------------------------------------------------------------------------*/
/* NLdynamicModule.h                                           (C) 2022-2025 */
/*                                                                           */
/* PASSMONL : Nonlinear Performant Assessment for Seismic Site Modelling     */
/* with finite-element (FEM) numerical modelling approach                    */
/* Created by : E. Foerster                                                  */
/*---------------------------------------------------------------------------*/
/*---------------------------------------------------------------------------*/
#ifndef PASSMONL_NLDYNAMICMODULE_H
#define PASSMONL_NLDYNAMICMODULE_H
...
: public ArcaneNLdynamicObject {
 ...
 private:
  ...
  Types::eElastType elast_type{Types::NoElastPropType};
  Types::eAnalysisType analysis_type{Types::PlaneStrain};
...
#endif // PASSMONL_NLDYNAMICMODULE_H
