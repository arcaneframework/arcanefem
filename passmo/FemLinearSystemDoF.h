...
//-----------------------------------------------------------------------------
/*---------------------------------------------------------------------------*/
/* FemLinearSystemDoF.h                                        (C) 2022-2022 */
/*                                                                           */
/* Linear system: Matrix A + Vector x + Vector b for Ax=b.                   */
/*---------------------------------------------------------------------------*/
#ifndef PASSMO_FEMLINEARSYSTEMDOF_H
#define PASSMO_FEMLINEARSYSTEMDOF_H
/*---------------------------------------------------------------------------*/
/*---------------------------------------------------------------------------*/
...
/*!
 * \internal.
 * \brief Implementation for FemLinearSystemDoF.
 */
class FemLinearSystemDoFImpl
{
public:

    virtual ~FemLinearSystemDoFImpl() = default;
 ...
 */
class FemLinearSystemDoF
{
public:

    FemLinearSystemDoF();
    ~FemLinearSystemDoF();
    FemLinearSystemDoF(const FemLinearSystemDoF&) = delete;
    FemLinearSystemDoF(FemLinearSystemDoF&&) = delete;
    FemLinearSystemDoF& operator=(FemLinearSystemDoF&&) = delete;
    FemLinearSystemDoF& operator=(const FemLinearSystemDoF&) = delete;
...
private:
    ...
    FemLinearSystemDoFImpl* m_p = nullptr;
